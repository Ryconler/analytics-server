...
INSERT INTO `custom`(`id`, `config`, `track`, `category`, `action`, `label`, `value`, `url`, `ip`, `time`) VALUES (4, 'WA-LNH5FK-1', 'conversion', '注册转化', '注册成功', '2', NULL, 'http://analytics.wzmxx.com/register', '101.245.241.102', '1592027918931');
INSERT INTO `custom`(`id`, `config`, `track`, `category`, `action`, `label`, `value`, `url`, `ip`, `time`) VALUES (5, 'WA-LNH5FK-1', 'event', '登录按钮', '点击', '登录', NULL, 'http://analytics.wzmxx.com/login', '101.245.241.102', '1592027918931');
INSERT INTO `record`(`id`, `config`, `open_time`, `close_time`, `url`, `urls`, `open_times`, `ip`, `address`, `service`, `referrer`, `wxh`, `depth`, `device`, `os`, `browser_name`, `browser_version`) 
  VALUES (1, 'WA-LNH5FK-1', '1592027918931', '1592029116717', 'http://analytics.wzmxx.com/login', 'http://analytics.wzmxx.com/login,http://analytics.wzmxx.com/analytics', '1592027918931,1592028080219', '101.245.241.102', NULL, NULL, '', '1440x900', '30', 'pc', 'Mac/iOS', 'Chrome', NULL);
INSERT INTO `record`(`id`, `config`, `open_time`, `close_time`, `url`, `urls`, `open_times`, `ip`, `address`, `service`, `referrer`, `wxh`, `depth`, `device`, `os`, `browser_name`, `browser_version`)
